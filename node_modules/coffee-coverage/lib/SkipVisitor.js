...
(function() {
  ...
  PRAGMAS = [
    {
      ...
      fn: function(self, node, match, options) {
        ...
        if (((_ref = parent.parent) != null ? _ref.type : void 0) === 'If') {
          ifBody = parent;
      ...
      fn: function(self, node, match, options) {
        ...
        return (_ref = ifNode.child('body')) != null ? _ref.markAll('skip', true) : void 0;
      }
    }, {
      ...
      fn: function(self, node, match, options) {
        ...
        return (_ref = ifNode.child('elseBody')) != null ? _ref.markAll('skip', true) : void 0;
      }
    }
  ];
  ...
  module.exports = SkipVisitor = (function() {
    ...
    SkipVisitor.prototype.visitComment = function(node) {
      var comment, found, _ref, _ref1;
      comment = (_ref = (_ref1 = node.node.comment) != null ? _ref1.trim().toLowerCase() : void 0) != null ? _ref : '';
      found = false;
