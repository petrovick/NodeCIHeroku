...
(function() {
  var CoverageInstrumentor, DEFAULT_INSTRUMENTOR, INSTRUMENTORS, executableName, fs, mkdirs, parseArgs, path, stripLeadingDotOrSlash, version, _, _ref, _ref1;
  ...
  _ref = require('./index'), CoverageInstrumentor = _ref.CoverageInstrumentor, version = _ref.version;

  INSTRUMENTORS = require('./coffeeCoverage').INSTRUMENTORS;

  _ref1 = require('./utils/helpers'), stripLeadingDotOrSlash = _ref1.stripLeadingDotOrSlash, mkdirs = _ref1.mkdirs;
